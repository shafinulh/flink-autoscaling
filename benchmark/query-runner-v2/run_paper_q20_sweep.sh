...
LOG_FILE="${LOG_FILE:-/opt/benchmark/query-runner-v2/paper-q20-sweep-${RUN_DATE}.log}"
FLINK_CONF_SUFFIX="${FLINK_CONF_SUFFIX:-v2}"

WARMUP_EVENTS="30000000"
EVAL_EVENTS="12500000"

NO_FILTER_FIXED_PREFIX_BYTES="0"
NO_FILTER_BLOOM_BITS="0"
FILTER_FIXED_PREFIX_BYTES="22"
...
run_case "NM1 baseline" "q20" "paper-draft" "$NO_FILTER_FIXED_PREFIX_BYTES" "$NO_FILTER_BLOOM_BITS"
run_case "NM1 + filters" "q20" "paper-draft" "$FILTER_FIXED_PREFIX_BYTES" "$FILTER_BLOOM_BITS"
run_case "NM2 - filters" "q20_unique" "paper-draft-3tables" "$NO_FILTER_FIXED_PREFIX_BYTES" "$NO_FILTER_BLOOM_BITS"
run_case "NM2" "q20_unique" "paper-draft-3tables" "$FILTER_FIXED_PREFIX_BYTES" "$FILTER_BLOOM_BITS"

log "Paper Q20 sweep complete."
