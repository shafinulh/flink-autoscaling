...
LOG_FILE="${LOG_FILE:-/opt/benchmark/query-runner-v2/paper-q9-sweep-${RUN_DATE}.log}"
...
run_case "NM1 baseline" "q9" "paper-draft" "$NO_FILTER_FIXED_PREFIX_BYTES" "$NO_FILTER_BLOOM_BITS"
run_case "NM1 + filters" "q9" "paper-draft" "$FILTER_FIXED_PREFIX_BYTES" "$FILTER_BLOOM_BITS"
run_case "NM2 - filters" "q9_unique" "paper-draft-3tables" "$NO_FILTER_FIXED_PREFIX_BYTES" "$NO_FILTER_BLOOM_BITS"
run_case "NM2" "q9_unique" "paper-draft-3tables" "$FILTER_FIXED_PREFIX_BYTES" "$FILTER_BLOOM_BITS"

log "Paper Q9 sweep complete."
